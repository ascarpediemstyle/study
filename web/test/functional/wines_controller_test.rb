...
class WinesControllerTest < ActionController::TestCase
  ...
  test "should create wine" do
    assert_difference('Wine.count') do
      post :create, wine: { comments: @wine.comments, id: @wine.id, price: @wine.price, wine_name: @wine.wine_name }
    end
  ...
  test "should update wine" do
    put :update, id: @wine, wine: { comments: @wine.comments, id: @wine.id, price: @wine.price, wine_name: @wine.wine_name }
    assert_redirected_to wine_path(assigns(:wine))
  end
